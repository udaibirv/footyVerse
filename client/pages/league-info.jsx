...
export default class LeagueInfo extends React.Component {
  ...
  render(){
    ...
    return (
        ...
        <header className="text-center">Welcome! Which league would you like to follow</header>
            ...
            <div className="col-12 col-md-6 col-lg-4">
              <div className="card league-card">
                ...
                <div className="card-body">
                  ...
                  <p>Seria A is Italy's top flight division and began in 1923. Italy's most succesfull club is Juventus who won a total of 70 major honors since the club was founded in 1897.
